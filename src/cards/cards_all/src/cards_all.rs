...
pub fn initialize() {
    ...
    DEFINITIONS.insert(cards_game_modifier::overlord_modifiers::overlord_empty_modifier);
    ...
    DEFINITIONS.insert(cards_game_modifier::overlord_modifiers::tutorial_disable_raid_sanctum);
