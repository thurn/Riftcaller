...
using FlexDirection = Riftcaller.Protos.FlexDirection;
using FontStyle = Riftcaller.Protos.FontStyle;
using OverflowClipBox = Riftcaller.Protos.OverflowClipBox;
using TextOverflow = Riftcaller.Protos.TextOverflow;
using TextOverflowPosition = Riftcaller.Protos.TextOverflowPosition;
using TextShadow = UnityEngine.UIElements.TextShadow;
using TimeValue = UnityEngine.UIElements.TimeValue;
using WhiteSpace = Riftcaller.Protos.WhiteSpace;
