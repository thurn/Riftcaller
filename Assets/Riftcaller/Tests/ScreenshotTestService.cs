...
namespace Riftcaller.Tests
{
  ...
  public sealed class ScreenshotTestService : MonoBehaviour
  {
    ...
    void OnSceneStart()
    {
      ...
      Registry.GameCharacterForPlayer(PlayerName.User).DisableAnimation();
      Registry.GameCharacterForPlayer(PlayerName.Opponent).DisableAnimation();
