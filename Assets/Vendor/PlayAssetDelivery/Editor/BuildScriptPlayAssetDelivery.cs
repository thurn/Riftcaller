...
namespace AddressablesPlayAssetDelivery.Editor
{
    ...
    public class BuildScriptPlayAssetDelivery : BuildScriptPackedMode
    {
        ...
        string CreateAssetPackDirectory(string assetPackName)
        {
            ...
            // NOTE: Unity broke this, had to add src/main/assets here, see
            // https://forum.unity.com/threads/pad-unity-2021-3-not-created-src-main-assets-automatically-for-custom-asset-bundle.1389945/
